...
If your command is registered in the [application container](../service/application#app-container), you may use the `Artisan::resolve` method to make it available to Artisan:
